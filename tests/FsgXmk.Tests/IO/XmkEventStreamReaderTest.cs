...
{
    public class XmkEventStreamReaderTest
    {
        protected virtual IXmkEventStreamReaderFactory Factory { get; } =
        ...
        public void ReadHopoDetection_ReturnsHopoDetectionXmkEvent()
        {
            ...
            try
            {
                ...
                // Act
                IXmkEvent @event;
                using (var stream = new MemoryStream(buffer, 0, XmkConstants.XmkEventSize, false))
