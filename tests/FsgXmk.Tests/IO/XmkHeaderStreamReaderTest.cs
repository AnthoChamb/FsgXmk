...
{
    public class XmkHeaderStreamReaderTest
    {
        protected virtual IXmkHeaderStreamReaderFactory Factory { get; } =
        ...
        public void Read_ReturnsXmkHeader()
        {
            ...
            try
            {
                ...
                // Act
                IXmkHeader header;
                using (var stream = new MemoryStream(buffer, 0, XmkConstants.XmkHeaderSize, false))
