...
{
    public class XmkBlobsStreamReaderTest
    {
        protected virtual IXmkBlobsStreamReaderFactory Factory { get; } =
        ...
        public void Read_ReturnsXmkBlobs()
        {
            ...
            try
            {
                ...
                using (var stream = new MemoryStream(buffer, 0, blobsLength, false))
